...
\chapter{Être développeur de Cadremploi} % Main chapter title

\label{apports} % For referencing the chapter elsewhere, use \ref{apports_techniques}

\lhead{Troisième partie. \emph{Être développeur de Cadremploi}} % This is for the header on each page - perhaps a shortened title
...
\input{Chapters/Chapter3/equipe}
\input{Chapters/Chapter3/technologies}
